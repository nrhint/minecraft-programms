...
def lake(depth):
        ...
        maxZ = depth
        r = 2
        #mc.setBlocks(x, y, z, x*depth*2, x*depth*2, 100)
        print("going")
        while loop == True:
                mc.setBlock(loopNum * x, loopNum * y, loopNum + maxZ, water)
                loopNum = loopNum + 1
                if loopNum > depth:
                        loop = False
...
def tree():
        ...
        x, y, z = mc.player.getPos()
        time.sleep(5)
        mc.setBlock(x, y, z, wood)
        #time.sleep(0.5)
        for h in range(random.randint(4, 5)):
                mc.setBlock(x, y+h+1, z, wood)
                #time.sleep(0.5)
